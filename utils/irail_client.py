...
class IRailClient:
    ...
    def __init__(self):
        ...
        self.session.headers.update({
            "User-Agent": "Azure-Train-Schedules/1.0'",
    ...
    def get_schedules(
        ...
        try:
            ...
            logging.error(f"[IRailClient] Error fetching schedules for {station}: {str(e)}")
            return None
    ...
    def __parse_liveboard_data(
        ...
        for schedule in schedules:
            try:
                ...
                actual_time = scheduled_time + timedelta(seconds=delay) if scheduled_time and delay > 0 else scheduled_time
                ...
                if direction == "departure":
                    ...
                    arrival_station = schedule.get("station", "Unknown")
                else:
                    departure_station = schedule.get("station", "Unknown")
                ...
                schedule_entry = {
                    ...
                    "delay_minutes": delay // 60 if delay > 0 else 0,  # Convert seconds to minutes
                    "canceled": canceled,
                    "status": "Canceled" if canceled else ("Delayed" if delay > 0 else "On Time")
                }
    ...
    def _parse_timestamp(self, timestamp_str: str) -> Optional[datetime]:
        ...
        try:
            ...
            logging.warning(f"[IRailClient] Error parsing timestamp '{timestamp_str}': {str(e)}")
            return None
